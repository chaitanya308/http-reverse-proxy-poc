...
public class TargetHostRoutingInterceptorTest extends AbstractTestNGSpringContextTests {

    @Autowired
    private TargetHostRoutingInterceptor targetHostRoutingInterceptor;
    ...
    public void testThatTargetHostIsUpdatedInTheURL() throws IOException {
        ...
        targetHostRoutingInterceptor.intercept(httpRequest, null, execution);
        ...
        Assertions.assertEquals("http://www.abc.com/test1", httpRequestArgumentCaptor.getValue().getURI().toString());
    }
}
